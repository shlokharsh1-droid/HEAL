    ...
    <header className="sticky top-0 z-50 border-b border-line bg-cream/95 backdrop-blur-sm">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 sm:px-8">
        ...
        <nav aria-label="Main" className="hidden items-center gap-7 md:flex">
          ...
          <Link
            ...
            className="rounded-md bg-clay-dark px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-clay-deeper"
          >
            Start a Chapter
          </Link>
        </nav>
      ...
      {open && (
        <nav
          id="mobile-menu"
          aria-label="Main"
          className="border-t border-line bg-cream px-5 pb-6 pt-3 md:hidden"
        >
          <ul className="flex flex-col gap-1">
            ...
            <li className="mt-3">
              <Link
                href="/start-a-chapter"
                onClick={() => setOpen(false)}
                className="block rounded-md bg-clay-dark px-4 py-3 text-center text-base font-semibold text-white hover:bg-clay-deeper"
              >
                Start a Chapter
              </Link>
            </li>
